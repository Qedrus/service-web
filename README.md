...
```
cd existing_repo
git remote add origin https://gitlab.com/DyiDriss/projet-web-server.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/DyiDriss/projet-web-server/-/settings/integrations)
